...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_click_metrics_clicked_at ON click_metrics (clicked_at DESC);
CREATE INDEX IF NOT EXISTS idx_click_metrics_clicked_entry ON click_metrics (clicked_at, entry_id);
